...
public class PercentageDiscountOnTransactionTests extends SelectBrowser{
	...
	public void dealCreationForTransactionLevelDiscount() throws BiffException, IOException, Exception{
		...
		Reporter.log("\n",true);
		id=cd.creatingDeal("TransactionLevelDiscount","DealCreationForPercentAmount");
	...
	public void createPromotionForTransactionLevel() throws BiffException, IOException, Exception{
		...
		Reporter.log("\n",true);
		cpm.createPromotions("TransactionLevelDiscount","creatingNewPromotionForPercentAmount",id);
