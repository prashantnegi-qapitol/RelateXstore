...
public class ItemLevelDiscountBuy1Get1Test {
	LoginMethods lm;
	WebDriver driver;
	...
	public void dealCreationForItemLevelDiscount() throws BiffException, IOException, Exception{
		Reporter.log("++++++++++++++++++++Creating Buy X Get X deal for Percent Amount++++++++++++++++++++",true);
		Reporter.log("\n",true);
		id=cd.creatingDeal("ItemLevelDiscount" , "BuyXGetXDealWithPercentAmount");
		Reporter.log("\n",true);
		Reporter.log("******************Creating  Buy X Get X  Deal Succesfull********************",true);

	}

	@Test(priority=2)
	public void createPromotion() throws BiffException, IOException, Exception{
		Reporter.log("++++++++++++++++++++Creating promotion for Buy X Get X deal and Percent Amount++++++++++++++++++++",true);
		Reporter.log("\n",true);
		itm.createPromotions("ItemLevelDiscount","BuyXGetXPromotionWithPercentAmount",id);
		Reporter.log("\n",true);
		Reporter.log("******************Creating Promotion for  Buy X Get X deal Succesfull********************",true);
