...
public class Buy2Get500FlatDiscountTest {
	...
	public void dealCreationForItemLevelDiscount() throws BiffException, IOException, Exception{
		...
		Reporter.log("\n",true);
		id=cd.creatingTieredDiscountDeal("ItemLevelDiscount" , "TieredDiscountDealWithFlatAmount");
		Reporter.log("\n",true);
	...
	public void createPromotion() throws BiffException, IOException, Exception{
		...
		Reporter.log("\n",true);
		itm.createPromotions("ItemLevelDiscount","TiredDiscountPromotionWithFlatAmount",id);
		Reporter.log("\n",true);
