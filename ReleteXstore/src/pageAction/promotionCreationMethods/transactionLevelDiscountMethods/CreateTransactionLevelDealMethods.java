package pageAction.promotionCreationMethods.transactionLevelDiscountMethods;
...
public class CreateTransactionLevelDealMethods extends SelectBrowser {

	WebDriver driver;
	PromotionAndDealForItemAndTransactionLevel pad;
	FilesAndFolders faf;
	HomePage hp;
	public CreateTransactionLevelDealMethods(WebDriver driver) {
		this.driver= driver;
