package pageAction.promotionCreationMethods.quantityPriceDiscountBasedOnTimePeriodMethods;
...
public class FixedQuantityPriceDealCreationMethods extends SelectBrowser {
	...
	public FixedQuantityPriceDealCreationMethods(WebDriver driver) {
		this.driver= driver;
