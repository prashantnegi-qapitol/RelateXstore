package pageAction.promotionCreationMethods.buyXGetXDealMethods;
...
public class BuyXGetXDealWithTimePeriodMethods extends SelectBrowser {
...
DealBasedOnTimePeriod td;
	public BuyXGetXDealWithTimePeriodMethods(WebDriver driver) {
		this.driver= driver;
	...
	public String creatingDeal(String sheetName,String uniqueName) throws BiffException, IOException, Exception{
		...
		String thresholdType=record[9].getContents();
		String thresholdStyle=record[8].getContents();
